...
| Section                                                                      | Content                                                                                                    |
| ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Document Control](#document-control)                                        | Identity, ownership, lifecycle status, revision metadata                                                   |
| [1. Introduction](#1-introduction)                                           | Purpose, scope, audience, references, glossary                                                             |
| [2. System Overview](#2-system-overview)                                     | Product context, external systems, operating constraints                                                   |
| [3. Stakeholders and Design Concerns](#3-stakeholders-and-design-concerns)   | Stakeholder list, concern catalog, NFR targets                                                             |
| [4. Architecture Overview](#4-architecture-overview)                         | Logical architecture, deployment topology, critical flows                                                  |
| [5. Viewpoints and Views](#5-viewpoints-and-views)                           | Viewpoint mapping, context/composition/logical/dependency/information/interface/interaction/resource views |
| [6. Design Elements and Constraints](#6-design-elements-and-constraints)     | Element catalog, interfaces, relationships, constraints, runtime state                                     |
| [7. Traceability](#7-traceability)                                           | Requirement-to-design mapping, coverage and gaps                                                           |
| [8. Design Rationale](#8-design-rationale)                                   | Key decisions, alternatives considered, tradeoff analysis                                                  |
| [9. Risks and Mitigations](#9-risks-and-mitigations)                         | Technical, operational, delivery, and security risks                                                       |
| [10. Summary](#10-summary)                                                   | Design posture and implementation readiness                                                                |
| [11. Data Design](#11-data-design)                                           | ERD summary, data description, data dictionary, cache/storage model                                        |
| [12. Component Design](#12-component-design)                                 | Subsystem responsibilities, internal/public interfaces, failure handling                                   |
| [13. Human Interface Design](#13-human-interface-design)                     | UX flows, key screens, interaction constraints                                                             |
| [14. Requirements Traceability Matrix](#14-requirements-traceability-matrix) | Requirement-to-design mapping table, coverage status                                                       |
| [15. Appendices](#15-appendices)                                             | Sequence flows, state models, config matrix, cache policy, security, testing, risk register                |
| [16. Design Decisions (Locked)](#16-design-decisions-locked)                 | Architectural decisions, deferred decisions                                                                |
